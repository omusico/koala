...
$cfg['get_auth_code'] = array(
	...
	'redirect'=>true,
	'commonParam'=> array(),
	'requestParam'=>array('response_type|@code','client_id|getAppKey','redirect_uri|getCallbackUrl','state','scope','display','force_login','confirm_login'),
	);
...
$cfg['passport_users_getLoggedInUser'] = array(
	...
	'method'=>'POST',
	'commonParam'=> array(),
	'requestParam'=>array('access_token|getToken'),
	);
...
$cfg['passport_users_isAppUser'] = array(
	...
	'method'=>'GET/POST',
	'commonParam'=> array(),
	'requestParam'=>array('access_token|getToken','uid','appid'),
	);
...
$cfg['passport_users_hasAppPermission'] = array(
	...
	'method'=>'GET/POST',
	'commonParam'=> array(),
	'requestParam'=>array('access_token|getToken','ext_perm','uid'),
	);
...
$cfg['passport_users_hasAppPermissions'] = array(
	...
	'method'=>'GET/POST',
	'commonParam'=> array(),
	'requestParam'=>array('access_token|getToken','ext_perms','uid'),
	);
//friends/getFriends
$cfg['friends_getFriends'] = array(
	...
	'method'=>'GET/POST',
	'commonParam'=> array(),
	'requestParam'=>array('access_token|getToken','page_no','page_size','sort_type'),
	);
//friends/areFriends
$cfg['friends_areFriends'] = array(
	...
	'method'=>'GET/POST',
	'commonParam'=> array(),
	'requestParam'=>array('access_token|getToken','uids1','uids2'),
	);
...
$cfg['passport_auth_revokeAuthorization'] = array(
	...
	'method'=>'GET/POST',
	'commonParam'=> array(),
	'requestParam'=>array('access_token|getToken','uid'),
	);
//super/msg/setnum
$cfg['super_msg_setnum'] = array(
	...
	'method'=>'GET/POST',
	'commonParam'=> array(),
	'requestParam'=>array('access_token|getToken','msgdetail','msgnum'),
	);
//super/msg/getnum
...
$cfg['hao123_saveOrder'] = array(
	...
	'method'=>'POST',
	'commonParam'=> array(),
	'requestParam'=>array('access_token|getToken','order_id','order_time','order_city','title','logo','url','price','goods_num','sum_price','summary','expire','addr','uid','mobile','tn','baiduid','bonus'),
	);
//hao123/updateExpire
$cfg['hao123_updateExpire'] = array(
	...
	'method'=>'GET/POST',
	'commonParam'=> array(),
	'requestParam'=>array('access_token|getToken','order_id','order_ids'),
	);
//hao123/useOrder
$cfg['hao123_useOrder'] = array(
	...
	'method'=>'GET/POST',
	'commonParam'=> array(),
	'requestParam'=>array('access_token|getToken','order_id','used_time'),
	);
//iplib/query
$cfg['iplib_query'] = array(
	...
	'method'=>'GET',
	'commonParam'=> array(),
	'requestParam'=>array('access_token|getToken','ip'),
	);
//batch/run
$cfg['batch_run'] = array(
	'summary' => '批量调用开放API',
	...
	'method'=>'GET',
	'commonParam'=> array(),
	'requestParam'=>array('access_token|getToken','method'),
	);
//bql/query
$cfg['bql_query'] = array(
	'summary' => '批量调用开放API',
	...
	'method'=>'GET/POST',
	'commonParam'=> array(),
	'requestParam'=>array('access_token|getToken','q'),
	);
//callback/add
$cfg['callback_add'] = array(
	...
	'method'=>'GET',
	'commonParam'=> array(),
	'requestParam'=>array('access_token|getToken','callback','event_name','url'),
	);
//callback/get
$cfg['callback_get'] = array(
	...
	'method'=>'GET',
	'commonParam'=> array(),
	'requestParam'=>array('access_token|getToken','callback','event_id'),
	);
//callback/update
$cfg['callback_update'] = array(
	...
	'method'=>'GET',
	'commonParam'=> array(),
	'requestParam'=>array('access_token|getToken','callback','event_id','event_name','url'),
	);
//callback/delete
...
$cfg['callback_trigger'] = array(
	...
	'method'=>'GET',
	'commonParam'=> array(),
	'requestParam'=>array('access_token|getToken','callback','event_id','msg'),
	);
//event/add
$cfg['event_add'] = array(
	'summary' => '注册普通事件',
	...
	'method'=>'GET',
	'commonParam'=> array(),
	'requestParam'=>array('access_token|getToken','callback','event_name','producer','subscriber'),
	);
//event/get
$cfg['event_get'] = array(
	'summary' => '查看普通事件',
...
$cfg['event_update'] = array(
	...
	'method'=>'GET',
	'commonParam'=> array(),
	'requestParam'=>array('access_token|getToken','callback','event_id','event_name','producer','subscriber'),
	);
//event/delete
...
$cfg['subscription_add'] = array(
	...
	'method'=>'GET',
	'commonParam'=> array(),
	'requestParam'=>array('access_token|getToken','callback','event_id','url'),
	);
//subscription/get
$cfg['subscription_get'] = array(
	...
	'method'=>'GET',
	'commonParam'=> array(),
	'requestParam'=>array('access_token|getToken','callback','sub_id'),
	);
//subscription/update
$cfg['subscription_update'] = array(
	...
	'method'=>'GET',
	'commonParam'=> array(),
	'requestParam'=>array('access_token|getToken','callback','sub_id','url'),
	);
//subscription/delete
...
$cfg['subscription_eventlist'] = array(
	...
	'method'=>'GET',
	'commonParam'=> array(),
	'requestParam'=>array('access_token|getToken','callback','event_id','event_name'),
	);
return $cfg;