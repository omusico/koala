...
$cfg['get_auth_code'] = array(
	...
	'redirect'=>true,
	'commonParam'=> array(),
	'requestParam'=>array('response_type|@code','client_id|getAppKey','redirect_uri|getCallbackUrl','state','scope|@get_user_info'),
	);
 ...
 * http://wiki.open.qq.com/wiki/website/API%E5%88%97%E8%A1%A8
 */
$commonParam = array('access_token|getToken','oauth_consumer_key|getAppKey','openid|getOpenid');
//访问用户资料
